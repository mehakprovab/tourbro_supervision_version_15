...
@Component({
  selector: 'app-cart-transfer-preffered-airline',
  templateUrl: './cart-transfer-preffered-airline.component.html',
  styleUrls: ['./cart-transfer-preffered-airline.component.scss']
})
export class CartTransferPrefferedAirlineComponent implements OnInit {
