import { Component, ViewChild, ElementRef, HostListener, forwardRef, Renderer2, AfterViewInit, IterableDiffers, Input, Output, EventEmitter, ChangeDetectorRef } from '@angular/core';
...
export class RangeSliderComponent implements ControlValueAccessor, AfterViewInit {
