...
export class HotelBookingReportComponent implements OnInit, OnDestroy {
    ...
    displayColumn: { key: string, value: string }[] = [
        ...
        { key: 'hcn', value: 'Hotel Confirmation Number' },
        { key: 'agentnetfare', value: 'Agent NetFare' },
        { key: 'markup', value: 'Agent Markup' },
        { key: 'TotalFare', value: 'Total Amount' },
        { key: 'HotelCheckIn', value: 'From' },
        { key: 'HotelCheckOut', value: 'To' },
    ...
    getVoucher(appReference) {
        ...
        this.router.navigate(['/reports/hotel-voucher'], { queryParams: { appReference, from: '' } });
    }
    ...
    openMailTrigger(data) {
        ...
        this.customerEmailTrigger = data.CustomerEmail;
        this.mailTriggerData = data;
    }

    mailTrigger(type){
        this.subSunk.sink = this.apiHandlerService.apiHandler('hotelEmail', 'post', {}, {},
    ...
    getPayNow(data) {
        this.totalAmount = data.BookingDetails.TotalAmount;
        this.payReference = data.BookingDetails.AppReference
        sessionStorage.setItem('HotelReportAppRef',this.payReference);
        this.getPaymentGateWays();
        this.intitiatePayment(data);
        this.checkWallet(this.payReference)
        this.showPaymentDetails = true;
        // const totalAmount = (this.currentUser.agent_balance + this.currentUser.credit_limit) + this.currentUser.due_amount;
