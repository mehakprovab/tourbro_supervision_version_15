...
@Component({
  selector: 'app-tour-enquiry-report',
  templateUrl: './tour-enquiry-report.component.html',
  styleUrls: ['./tour-enquiry-report.component.scss']
})
export class TourEnquiryReportComponent implements OnInit {
  ...
  private subSunk = new SubSink();
    ...
    download(type: SupportedExtensions, orientation?: string) {
        ...
        this.exportAsService.save(this.config, `b2b-tour-enquiry`).subscribe((_) => {
    ...
    showEnquiryDetails(data){
        ...
        this.router.navigate(['/report/tour-enquiry-details'],{queryParams:data})
    }
    ...
    applyFilter(text: string) {
        ...
        filterArray = respDataCopy.slice().filter((objData, index) => {
            const filterOnFields = {
                ...
                departure_place: objData.departure_place,
                departure_date: objData.departure_date,
                name: objData.name,
                phone: objData.phone,
                email: objData.email,
            }
