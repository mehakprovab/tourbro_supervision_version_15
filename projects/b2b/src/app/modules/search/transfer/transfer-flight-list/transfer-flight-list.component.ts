...
@Component({
  selector: 'app-transfer-flight-list',
  templateUrl: './transfer-flight-list.component.html',
  styleUrls: ['./transfer-flight-list.component.scss']
})
export class TransferFlightListComponent implements OnInit {
