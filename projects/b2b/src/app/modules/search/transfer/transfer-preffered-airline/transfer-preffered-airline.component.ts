...
@Component({
  selector: 'app-transfer-preffered-airline',
  templateUrl: './transfer-preffered-airline.component.html',
  styleUrls: ['./transfer-preffered-airline.component.scss']
})
export class TransferPrefferedAirlineComponent implements OnInit {
  @Input() getAirports = [];
  @Input() inputFor;
