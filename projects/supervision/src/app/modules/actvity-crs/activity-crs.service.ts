...
export class ActivityCrsService {
    seasonList = new BehaviorSubject<any>('');
     ...
     getCountryData: BehaviorSubject<any> = new BehaviorSubject<any>([]);
     getActivityUpdateData: BehaviorSubject<any> = new BehaviorSubject<any>([]);
    constructor(
