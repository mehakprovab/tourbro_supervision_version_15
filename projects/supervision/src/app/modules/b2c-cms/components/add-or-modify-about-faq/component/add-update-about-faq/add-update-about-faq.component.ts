...
@Component({
  selector: 'app-add-update-about-faq',
  templateUrl: './add-update-about-faq.component.html',
  styleUrls: ['./add-update-about-faq.component.scss']
})
export class AddUpdateAboutFaqComponent implements OnInit {
...
onSubmit() {
   // console.log(this.addOrUpdate,this.regConfig.value);
    ...
    switch (this.addOrUpdate) {
        case 'add':
            this.subSunk.sink = this.cmsService.addaboutFaq(req)
                .subscribe(resp => {
