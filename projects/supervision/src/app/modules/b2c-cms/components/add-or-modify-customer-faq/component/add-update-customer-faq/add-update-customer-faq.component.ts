...
@Component({
  selector: 'app-add-update-customer-faq',
  templateUrl: './add-update-customer-faq.component.html',
  styleUrls: ['./add-update-customer-faq.component.scss']
})
export class AddUpdateCustomerFaqComponent implements OnInit {
...
onSubmit() {
   // console.log(this.addOrUpdate,this.regConfig.value);
    ...
    switch (this.addOrUpdate) {
        case 'add':
            this.subSunk.sink = this.cmsService.addCustomerFaq(req)
                .subscribe(resp => {
        ...
        case 'update':
            ...
            this.subSunk.sink = this.cmsService.updateFaq(req)
                .subscribe(resp => {
