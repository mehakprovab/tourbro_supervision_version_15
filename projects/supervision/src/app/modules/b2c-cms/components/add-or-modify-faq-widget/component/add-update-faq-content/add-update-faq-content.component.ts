...
@Component({
  selector: 'app-add-update-faq-content',
  templateUrl: './add-update-faq-content.component.html',
  styleUrls: ['./add-update-faq-content.component.scss']
})
export class AddUpdateFaqContentComponent implements OnInit {
...
onSubmit() {
   // console.log(this.addOrUpdate,this.regConfig.value);
    ...
    switch (this.addOrUpdate) {
        case 'add':
            this.subSunk.sink = this.cmsService.addFaq(req)
                .subscribe(resp => {
