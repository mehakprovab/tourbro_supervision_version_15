...
@Component({
  selector: 'app-add-update-service-faq',
  templateUrl: './add-update-service-faq.component.html',
  styleUrls: ['./add-update-service-faq.component.scss']
})
export class AddUpdateserviceFaqComponent implements OnInit {
...
onSubmit() {
   // console.log(this.addOrUpdate,this.regConfig.value);
    ...
    switch (this.addOrUpdate) {
        case 'add':
            this.subSunk.sink = this.cmsService.addserviceFaq(req)
                .subscribe(resp => {
