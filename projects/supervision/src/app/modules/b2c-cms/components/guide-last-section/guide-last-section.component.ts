...
@Component({
  ...
  templateUrl: './guide-last-section.component.html',
  styleUrls: ['./guide-last-section.component.scss']
})
export class GuideLastSectionComponent implements OnInit {
...
validateFileSize(size: number): boolean {
  ...
  return true;
   ...
   getGuideSections() {
     this.noData = true;
     this.respData = [];
     this.subSunk.sink = this.apiHandlerService.apiHandler('guideLastSectionList', 'post', {}, {}, {})
       .subscribe(resp => {
 ...
 editList(data) {
  ...
  this.selectedFileName = '';
   ...
   onSearchSubmit() {
     ...
     const apiEndpoint = this.editingId ? 'addGuideLastSection' : 'addGuideLastSection';
