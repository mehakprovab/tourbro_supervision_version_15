...
@Component({
    ...
    styleUrls: ['./slider-image-list.component.scss']
})

export class SliderImageListComponent implements OnInit,OnDestroy {
    ...
    updateSlider(data) {
        ...
        this.activateTab.emit({ tabId: 'add_update_sliderimage', data });
    }
    ...
    sortData(sort: Sort) {
        ...
        this.respData = data.sort((a, b) => {
            ...
            switch (sort.active) {
                // case 'module': return this.utility.compare('' + a.module.toLocaleLowerCase(), '' + b.module.toLocaleLowerCase(), isAsc);
