...
@Component({
  selector: 'app-supplier-markup-update',
  templateUrl: './supplier-markup-update.component.html',
  styleUrls: ['./supplier-markup-update.component.scss']
})
export class SupplierMarkupUpdateComponent implements OnInit {
  @Input('getSupplierToUpdate') getDataToUpdate;
  @Output() supplierListdata = new EventEmitter<any>();
  subSunk = new SubSink();
  regConfig: FormGroup;
  towards = [
  ...
  getUpdateData() {
      this.subSunk.sink = this.markupsService.toUpdateB2CSupplierData.subscribe(data => {
              ...
              this.subSunk.sink = this.apiHandlerService.apiHandler('addB2cMarkup', 'post', {}, {}, {
                  ...
                  .subscribe(resp => {
                      ...
                      if (resp.statusCode == 200 || resp.statusCode == 201) {
                          ...
                          this.regConfig.reset();
                          this.supplierListdata.emit({ tabId: 'default_supplier_list', data: {} });
                      } else {
