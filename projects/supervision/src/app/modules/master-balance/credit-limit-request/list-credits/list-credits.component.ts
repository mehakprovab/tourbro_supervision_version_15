...
export class ListCreditsComponent implements OnInit {
    ...
    displayColumn: { key: string, value: string }[] = [
        ...
        { key: 'last_deposit_date', value: 'Last Deposit Date' },
        { key: 'last_deposit_amount', value: 'Last Deposit Amount' },
        { key: 'credit_already_due', value: 'Credit Already Due' },
        ...
        this.subSunk.sink = this.apiHandlerService.apiHandler('creditLimitReqList', 'post', {}, {},
            {
                ...
                "requested_date_from": formatDate(this.searchForm.value.fromDate, 'YYYY-MM-DD'), // ? formatDate(this.regConfig.value.booked_from_date, 'YYYY-MM-DD') : formatDate(fromDate,'YYYY-MM-DD'),
                "requested_date_to":formatDate( this.searchForm.value.toDate,'YYYY-MM-DD'),
    ...
    receiveSearchValues($event) {
        console.log("in transaction logs", $event, this.respData, new Date($event.fromDate).getTime());
        let resultData = [];
