...
export class SentCreditLimitComponent implements OnInit, OnDestroy {
    ...
    displayColumn: { key: string, value: string }[] = [
        ...
        { key: 'credit_alreay_due', value: 'Credit Already Due' },
        { key: 'status', value: 'Status' },
        { key: 'request_sent_on', value: 'Request Sent On' },
        ...
        this.paymentService.fetch(data)
            ...
            .subscribe(resp => {
                ...
                if (resp.statusCode == 200) {
                    this.noData = false;
                    this.respData = resp.data['credit_limit_request_details'];
