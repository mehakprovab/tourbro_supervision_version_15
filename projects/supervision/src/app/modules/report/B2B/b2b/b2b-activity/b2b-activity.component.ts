...
downloadPdf() {
    this.utility.downloadElementAsPdf('b2b-activity-report', 'B2B_Activity_Report', 'landscape');
}
  ...
  cancelTicketPopup(data) {
      console.log('B2B Activity bundle_booking:', data && data.BookingDetails ? data.BookingDetails.bundle_booking : data && data.bundle_booking, data);
