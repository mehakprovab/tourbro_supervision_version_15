...
@Component({
    selector: 'app-b2b-car',
    templateUrl: './b2b-car.component.html',
    styleUrls: ['./b2b-car.component.scss']
})
export class B2bCarComponent implements OnInit, OnDestroy {
    ...
    getB2cCarReport() {
        ...
        this.subSunk.sink = this.apiHandlerService.apiHandler('b2bCarReport', 'post', {}, {}, reqBody
        )
            .subscribe(resp => {
