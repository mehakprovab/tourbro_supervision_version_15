...
@Component({
  ...
  templateUrl: './b2c-car-cancel.component.html',
  styleUrls: ['./b2c-car-cancel.component.scss']
})
export class B2cCarCancelComponent implements OnInit,OnDestroy {
  ...
  calculateDiff(fromDate,toDate){
    ...
    findLeaduserDetails(data){
        if(data){
           ...
           return `${leadUser[0].FirstName} ${leadUser[0].LastName}`;
        }
    }
