...
@Component({
  selector: 'app-b2c-hotel-enquiry',
  templateUrl: './b2c-hotel-enquiry.component.html',
  styleUrls: ['./b2c-hotel-enquiry.component.scss']
})
export class B2cHotelEnquiryComponent implements OnInit {
  ...
  config: any = {
      type: 'pdf',
      elementIdOrContent: 'b2c-hotel-enquiry',
      options: {
          jsPDF: {
  ...
  download(type: any, orientation?: string) {
    ...
    this.config.type = type;
        if (type === 'xlsx' || type === 'xls') {
            this.utility.downloadElementAsExcel(this.config.elementIdOrContent, 'b2c-hotel-enquiry');
            return;
        }
        if (orientation) {
