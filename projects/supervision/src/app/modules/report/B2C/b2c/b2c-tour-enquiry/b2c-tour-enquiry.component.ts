...
@Component({
  ...
  templateUrl: './b2c-tour-enquiry.component.html',
  styleUrls: ['./b2c-tour-enquiry.component.scss']
})
export class B2cTourEnquiryComponent implements OnInit {
    ...
    getB2CTourEnquiry() {
        ...
        this.subSunk.sink = this.apiHandlerService.apiHandler('b2cTourEnquiryList', 'post', {}, {},req
            )
            .subscribe(resp => {
                console.log(resp);
    ...
    download(type: SupportedExtensions, orientation?: string) {
        ...
        this.exportAsService.save(this.config, `b2c-tour-enquiry`).subscribe((_) => {
            // save started
            console.log(`success`);
    ...
    downloadPdf() {
        const element = document.getElementById('b2c-tour-enquiry');
        html2canvas(element).then(canvas => {
            ...
            pdf.save('B2C_Tour_Enquiry_Report.pdf');
            this.swalService.alert.success();
        });
    }
