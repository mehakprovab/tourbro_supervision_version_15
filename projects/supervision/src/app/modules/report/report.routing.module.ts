...
import { HeliVoucherComponent } from './B2C/b2c/b2c-heli/components/heli-voucher/heli-voucher.component';
import { HeliInvoiceComponent } from './B2C/b2c/b2c-heli/components/heli-invoice/heli-invoice.component';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'b2c-heli/voucher',
        component: HeliVoucherComponent,
        data: {extraParameter: ''}
      },
      {
        path: 'b2c-heli/invoice',
        component: HeliInvoiceComponent,
        data: {extraParameter: ''}
      },
      {
        path: 'b2c-bus',
      ...
      {
        path: 'b2c-bus/voucher',
        component: BusVoucherComponent,
        data: {extraParameter: ''}
      },
      {
        path: 'b2c-bus/invoice',
      ...
      {
        path: 'b2c-dynamic-package/voucher',
        canActivate: [AuthGuard],
        component: DynamicPackageVoucherComponent,
        data: {extraParameter: 'b2c-reports-Menus'}
      },
      {
