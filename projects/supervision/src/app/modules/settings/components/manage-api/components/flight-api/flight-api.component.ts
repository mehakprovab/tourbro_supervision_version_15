...
export class FlightApiComponent implements OnInit {
    ...
    displayColumn: { key: string; value: string }[] = [
        ...
        // { key: "B2B Active", value: "B2B Active" },
        { key: "B2C Active", value: "Status" },
    ...
    getFlightList() {
        this.subSunk.sink = this.apiHandlerService.apiHandler("hotelManageApiList", "post", {}, {}, { module: "flight", userType: "B2C", }
        ).subscribe((resp) => {
