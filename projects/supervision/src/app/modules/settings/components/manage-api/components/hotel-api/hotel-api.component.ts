...
@Component({
    selector: 'app-hotel-api',
    templateUrl: './hotel-api.component.html',
    styleUrls: ['./hotel-api.component.scss']
})
export class HotelApiComponent implements OnInit {
    ...
    displayColumn: { key: string, value: string }[] = [
        ...
        // { key: "b2b_status", value: 'B2B Status' },
        { key: "b2c_status", value: 'Status' },
    ...
    onStatusUpdate(data,module_type): void {
        const request = {
            id: data.id,
