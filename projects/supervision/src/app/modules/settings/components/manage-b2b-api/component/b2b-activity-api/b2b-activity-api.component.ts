...
@Component({
  selector: 'app-b2b-activity-api',
  templateUrl: './b2b-activity-api.component.html',
  styleUrls: ['./b2b-activity-api.component.scss']
})
export class B2bActivityApiComponent implements OnInit {
