...
@Component({
  selector: 'app-b2b-hotel-api',
  templateUrl: './b2b-hotel-api.component.html',
  styleUrls: ['./b2b-hotel-api.component.scss']
})
export class B2bHotelApiComponent implements OnInit {
