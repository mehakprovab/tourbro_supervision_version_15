...
@Component({
  selector: 'app-b2b-transfer-api',
  templateUrl: './b2b-transfer-api.component.html',
  styleUrls: ['./b2b-transfer-api.component.scss']
})
export class B2bTransferApiComponent implements OnInit {
