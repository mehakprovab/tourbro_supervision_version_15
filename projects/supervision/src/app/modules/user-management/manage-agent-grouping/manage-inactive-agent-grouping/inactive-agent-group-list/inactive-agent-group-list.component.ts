...
@Component({
  selector: 'app-inactive-agent-group-list',
  templateUrl: './inactive-agent-group-list.component.html',
  styleUrls: ['./inactive-agent-group-list.component.scss']
})
export class InactiveAgentGroupListComponent implements OnInit {
  ...
  onStatusChange(data) {
      ...
      this.subSunk.sink = this.apiHandlerService.apiHandler('updateAgentGroupStatus', 'post', {}, {},
