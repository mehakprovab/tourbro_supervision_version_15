...
const log = new Logger('users/ActiveB2cUserListComponent');
let filterArray: Array<any> = [];
let respDataCopy: Array<any> = [];

@Component({
  selector: 'app-active-b2c-user-list',
  templateUrl: './active-b2c-user-list.component.html',
  styleUrls: ['./active-b2c-user-list.component.scss']
})
export class ActiveB2cUserListComponent implements OnInit {
