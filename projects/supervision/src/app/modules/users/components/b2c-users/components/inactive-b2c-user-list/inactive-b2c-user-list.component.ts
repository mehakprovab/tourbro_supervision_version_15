...
@Component({
  selector: 'app-inactive-b2c-user-list',
  templateUrl: './inactive-b2c-user-list.component.html',
  styleUrls: ['./inactive-b2c-user-list.component.scss']
})
export class InactiveB2cUserListComponent implements OnInit {
