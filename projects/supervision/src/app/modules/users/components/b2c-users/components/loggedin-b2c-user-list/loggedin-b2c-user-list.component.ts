...
const log = new Logger('users/LoggedinB2cUserListComponent');
let filterArray: Array<any> = [];
let respDataCopy: Array<any> = [];

@Component({
  selector: 'app-loggedin-b2c-user-list',
  templateUrl: './loggedin-b2c-user-list.component.html',
  styleUrls: ['./loggedin-b2c-user-list.component.scss']
})
export class LoggedinB2cUserListComponent implements OnInit {
