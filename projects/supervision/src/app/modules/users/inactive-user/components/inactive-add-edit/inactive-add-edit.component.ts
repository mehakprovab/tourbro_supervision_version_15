...
import { formatDate } from 'projects/supervision/src/app/core/services/format-date';
import { ApiHandlerService } from 'projects/supervision/src/app/core/api-handlers';
import { UsersService } from '../../../users.service';

const log = new Logger('users/InactiveAddEditComponent');
@Component({
    selector: 'app-inactive-add-edit',
    templateUrl: './inactive-add-edit.component.html',
    styleUrls: ['./inactive-add-edit.component.scss']
})
export class InactiveAddEditComponent implements OnInit {
    usersForm: FormGroup;
    userTitles: any;
    countries: any;
    user: any;
